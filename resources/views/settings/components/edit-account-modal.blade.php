<div class="modal fade" tabindex="-1" id="edit_account_modal" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Edit an Account</h3>
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ki-solid ki-cross fs-1"></i>
                </div>
            </div>
            <div class="modal-body">
                <form id="edit_account_modal_form" class="mb-0">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button id="update_account" type="button" class="btn btn-primary">Save</button>
            </div>
        </div>
    </div>
</div>