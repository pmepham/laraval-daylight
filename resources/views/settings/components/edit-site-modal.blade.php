<div class="modal fade" tabindex="-1" id="edit_site_modal" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit_site_modal_form" class="mb-0">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button id="update_site" type="button" class="btn btn-primary" data-url="">Save</button>
            </div>
        </div>
    </div>
</div>